...
assert.strictEqual(JSON.parse(backupText).version, 4)
assert.ok(storage.makeBackupFileName().startsWith('backup-'))
assert.strictEqual(storage.makeBackupFileName(new Date('2026-06-03T02:01:00.000Z')), 'backup-260603-100100.json')
assert.ok(/^backup-\d{6}-\d{6}\.json$/.test(storage.makeBackupFileName()))
