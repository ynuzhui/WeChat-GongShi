...
assert.ok(storage.makeBackupFileName().startsWith('工时清单备份-'))
assert.strictEqual(storage.makeBackupFileName(new Date('2026-05-26T08:08:23.448Z')), '工时清单备份-2026-05-26-16-08.json')
assert.ok(/^工时清单备份-\d{4}-\d{2}-\d{2}-\d{2}-\d{2}\.json$/.test(storage.makeBackupFileName()))
